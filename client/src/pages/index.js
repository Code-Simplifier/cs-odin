  ...
  function Sidebar() {
    return (
      <VStack borderRadius={16} margin={3} minH="98vh" bgColor="#001623" width={310}>
          ...
          >
            <Image src={userPic} borderRadius="50%" boxSize={9} />
            <Text fontFamily={lato_semibold.style.fontFamily}>{user}</Text>
          </Button>
        {/* new chat */}
        <Button
          color="teal.200"
        ...
        <br />
        <Divider borderColor="white" width="90%" />
        <Button
          color="teal.200"
          borderColor="teal.300"
          variant="outline"
          ...
          onClick={logout}
        >
          <Text fontFamily={lato_semibold.style.fontFamily} textTransform="uppercase">Logout</Text>
        </Button>
      </VStack>
    )
  }
